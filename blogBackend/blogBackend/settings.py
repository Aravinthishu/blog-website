...
SECRET_KEY = 'django-insecure-^ms-08(oh-*ee)x3$s(edd1@_c_c!dq&kj=!j8cygjgto7mj^y'
...
#             'username': '',
#             'password': '',
#             'authSource': 'admin',  # typically 'admin'
#             'authMechanism': 'SCRAM-SHA-1'  # or another authentication mechanism
#         }
#     }
# }
